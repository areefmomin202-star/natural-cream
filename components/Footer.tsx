...
import { getWhatsAppOrderUrl, WHATSAPP_DISPLAY_NUMBER, useProduct } from '../data/productData';
          ...
          <div className="space-y-2">
            ...
            <div className="bg-stone-900/90 rounded-xl p-3.5 border border-stone-800">
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-xs text-stone-500 line-through">MRP ₹{product.mrp}</span>
                <span className="text-xs font-bold text-rose-400">{product.discountPercent}% OFF</span>
              </div>
              <p className="text-[11px] text-stone-400 mt-1">
                Save ₹{product.savings} on your order. Free doorstep shipping across India.
              </p>
            </div>
          </div>
